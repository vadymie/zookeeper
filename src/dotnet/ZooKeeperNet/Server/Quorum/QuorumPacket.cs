...
{
private static Logger log = LogManager.GetLogger(nameof(QuorumPacket));
  public QuorumPacket() {
  }
  public QuorumPacket(
  int type
...
,
  byte[] data
,
  System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ZKId> authinfo
) {
Type=type;
Zxid=zxid;
Data=data;
Authinfo=authinfo;
  ...
  public void Deserialize(IInputArchive a_, String tag) {
    ...
    Data=a_.ReadBuffer("data");
    {
      ...
      if (vidx1!= null) {          var tmpLst=new System.Collections.Generic.List<ZooKeeperNet.Data.ZKId>();
