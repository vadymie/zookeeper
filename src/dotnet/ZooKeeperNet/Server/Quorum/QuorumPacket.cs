...
namespace ZooKeeperNet.Server.Quorum
{
	public class QuorumPacket : IRecord, IComparable
	{
		private static readonly ILogProducer log = TypeLogger<QuorumPacket>.Instance;
		public QuorumPacket ()
		{
		}
		public QuorumPacket (int type, long zxid, byte[] data, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ZKId> authinfo)
		{
			Type = type;
			Zxid = zxid;
			Data = data;
		...
		public System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ZKId> Authinfo { get; set; }
		...
		public void Deserialize (IInputArchive a_, String tag)
		{
			...
			Data = a_.ReadBuffer("data");
			{
				...
				if (vidx1 != null)
				{
					var tmpLst = new System.Collections.Generic.List<ZooKeeperNet.Data.ZKId>();
					for (; !vidx1.Done(); vidx1.Incr())
					{
						ZooKeeperNet.Data.ZKId e1;
						e1 = new ZooKeeperNet.Data.ZKId();
						a_.ReadRecord(e1, "e1");
						tmpLst.Add(e1);
					}
					Authinfo = tmpLst;
