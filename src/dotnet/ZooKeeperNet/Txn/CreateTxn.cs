...
namespace ZooKeeperNet.Txn
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<CreateTxn>.Instance;
		public CreateTxn ()
		{
		}
		public CreateTxn (string path, byte[] data, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> acl, bool ephemeral, int parentCVersion)
		{
			Path = path;
			Data = data;
			Acl = acl;
		...
		public System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> Acl { get; set; }
		...
		public void Deserialize (IInputArchive a_, String tag)
		{
			...
			Data = a_.ReadBuffer("data");
			{
				...
				if (vidx1 != null)
				{
					var tmpLst = new System.Collections.Generic.List<ZooKeeperNet.Data.ACL>();
					for (; !vidx1.Done(); vidx1.Incr())
					{
						ZooKeeperNet.Data.ACL e1;
						e1 = new ZooKeeperNet.Data.ACL();
						a_.ReadRecord(e1, "e1");
						tmpLst.Add(e1);
					}
					Acl = tmpLst;
