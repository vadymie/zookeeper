...
namespace ZooKeeperNet.Txn
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<CreateTxnV0>.Instance;
		public CreateTxnV0 ()
		{
		}
		public CreateTxnV0 (string path, byte[] data, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> acl, bool ephemeral)
		{
			Path = path;
			Data = data;
			Acl = acl;
