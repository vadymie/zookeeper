...
namespace ZooKeeperNet.Txn
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<SetACLTxn>.Instance;
		public SetACLTxn ()
		{
		}
		public SetACLTxn (string path, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> acl, int version)
		{
			Path = path;
			Acl = acl;
			Version = version;
