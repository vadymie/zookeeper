...
namespace ZooKeeperNet.Proto
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<SetACLRequest>.Instance;
		public SetACLRequest ()
		{
		}
		public SetACLRequest (string path, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> acl, int version)
		{
			Path = path;
			Acl = acl;
			Version = version;
