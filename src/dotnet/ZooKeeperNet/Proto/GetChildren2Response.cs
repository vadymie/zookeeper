...
namespace ZooKeeperNet.Proto
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<GetChildren2Response>.Instance;
		public GetChildren2Response ()
		{
		}
		public GetChildren2Response (System.Collections.Generic.IEnumerable<string> children, ZooKeeperNet.Data.Stat stat)
		{
			Children = children;
			Stat = stat;
		}
