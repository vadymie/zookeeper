...
namespace ZooKeeperNet.Proto
{
	...
	{
		private static readonly ILogProducer log = TypeLogger<CreateRequest>.Instance;
		public CreateRequest ()
		{
		}
		public CreateRequest (string path, byte[] data, System.Collections.Generic.IEnumerable<ZooKeeperNet.Data.ACL> acl, int flags)
		{
			Path = path;
			Data = data;
			Acl = acl;
