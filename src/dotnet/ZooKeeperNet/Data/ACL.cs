...
namespace ZooKeeperNet.Data
{
	public class ACL : IRecord, IComparable
	{
		private static readonly ILogProducer log = TypeLogger<ACL>.Instance;
		public ACL ()
		{
		}
		public ACL (int perms, ZooKeeperNet.Data.ZKId id)
		{
			Perms = perms;
			Id = id;
		}
		public int Perms { get; set; }
		public ZooKeeperNet.Data.ZKId Id { get; set; }
